package cn.joylau.code.security.session;
 ...
 */
@Data
public class SessionRegistryCache implements SessionRegistry,
    ...
    public SessionRegistryCache() {
        this.principals = new ConcurrentHashMap<>();
        this.sessionIds = new ConcurrentHashMap<>();
    }

    public SessionRegistryCache(ConcurrentMap<Object, Set<String>> principals, Map<String, SessionInformation> sessionIds) {
